...
assert Data.cart3 == con2.get('shopping-cart?product=orange', headers={'X-session':session1})[0]
assert Data.cart4 == con3.get('shopping-cart?product=pear', headers={'X-session':session1})[0]

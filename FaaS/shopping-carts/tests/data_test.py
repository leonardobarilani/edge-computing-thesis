class DataTest:
	...
	test_function_1 = """Session metadata <counter-k3d-p2>: {"session":"counter-k3d-p2","proprietaryLocation":"k3d-p2","currentLocation":"k3d-p2"}
...
"""
	...
	test_function_2 = """Session metadata <counter-k3d-p2>: {"session":"counter-k3d-p2","proprietaryLocation":"k3d-p2","currentLocation":"k3d-p2"}
...
New session: {"session":"marco","proprietaryLocation":"k3d-p3","currentLocation":"k3d-p3"}"""
	...
	test3 = """Session metadata <marco>: {"session":"marco","proprietaryLocation":"k3d-p3","currentLocation":"k3d-p3"}
...
{"session":"marco","proprietaryLocation":"k3d-p3","currentLocation":"k3d-p3"}"""
	...
	offload2 = """Offloading:
k3d-p1
{"session":"counter-k3d-p2","proprietaryLocation":"k3d-p2","currentLocation":"k3d-p2"}"""

	test1 = """Session metadata <marco>: {"session":"marco","proprietaryLocation":"k3d-p3","currentLocation":"k3d-p2"}
Session data <marco>: {"session_data":[{"key":"products","data":"{\\"list\\":[\\"kiwi\\"]}"}]}
"""

	test2 = """Session metadata <counter-k3d-p2>: {"session":"counter-k3d-p2","proprietaryLocation":"k3d-p2","currentLocation":"k3d-p1"}
Session data <counter-k3d-p2>: {"session_data":[{"key":"kiwi","data":"1"}]}
"""

	cart2 = "[kiwi, banana]"

	test3 = """Session metadata <marco>: {"session":"marco","proprietaryLocation":"k3d-p3","currentLocation":"k3d-p2"}
Session data <marco>: {"session_data":[{"key":"products","data":"{\\"list\\":[\\"kiwi\\",\\"banana\\"]}"}]}
"""

	test4 = """Session metadata <counter-k3d-p2>: {"session":"counter-k3d-p2","proprietaryLocation":"k3d-p2","currentLocation":"k3d-p1"}
...
New session: {"session":"marco","proprietaryLocation":"k3d-p3","currentLocation":"k3d-p3"}"""
	...
	onload2 = """Unloaded:
Old session: {"session":"counter-k3d-p2","proprietaryLocation":"k3d-p2","currentLocation":"k3d-p1"}
New session: {"session":"counter-k3d-p2","proprietaryLocation":"k3d-p2","currentLocation":"k3d-p2"}"""

	cart3 = "[kiwi, banana, orange]"

	cart4 = "[kiwi, banana, orange, pear]"

	test5 = """Session metadata <marco>: {"session":"marco","proprietaryLocation":"k3d-p3","currentLocation":"k3d-p3"}
